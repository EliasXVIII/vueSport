...
const viewFunction = viewModel => (0, _inferno.createVNode)(1, "div", null, viewModel.props.appointments.map((item, index) => (0, _inferno.createComponentVNode)(2, _item_layout.TooltipItemLayout, {
    item: item,
    index: index
}, item.key)), 0);
