...
describe("license check", () => {
    ...
    test.each([{
        ...
        token: void 0,
        version: "1.0.50"
    }])("W0019 error should be logged if license is empty", _ref2 => {
        let {
            token: token,
            version: version
        } = _ref2;
    ...
    test.each([{
        ...
        token: TOKEN_23_1,
        version: "123"
    }])("W0022 error should be logged if version is preview [%#]", _ref3 => {
        let {
            token: token,
            version: version
        } = _ref3;
    ...
    test.each([{
        ...
        token: TOKEN_23_2,
        version: "23.2.6"
    }])("No messages should be logged if license is valid", _ref4 => {
        let {
            token: token,
            version: version
        } = _ref4;
    ...
    test.each([{
        ...
        token: TOKEN_23_2,
        version: "42.4.5"
    }])("W0020 error should be logged if license is outdated", _ref5 => {
        let {
            token: token,
            version: version
        } = _ref5;
    ...
    test.each([{
        ...
        token: "3.2.1",
        version: "1.2.3"
    }])("W0021 error should be logged if license is corrupted/invalid [%#]", _ref6 => {
        let {
            token: token,
            version: version
        } = _ref6;
